...
<head>
    ...
    <style>
        body {
            ...
            margin: 20px;
            background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZfksbEnGmpUFzh-5RDIHBeYF7jychKT47tg&usqp=CAU"); /* Set the background image URL */
...
<body>
    ...
    <form:form method="POST" modelAttribute="ban" action="/withdrew">
        <table>
            <tr>
            ...
            <tr>
                <td colspan="2"><input type="submit" value="withdrew" class="btn btn-primary" /></td>
            </tr>
        </table>
    </form:form>
